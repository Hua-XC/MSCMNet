...
parser.add_argument('--model_path', default='result/MSCMNet/save_model/', type=str, help='model save path')
parser.add_argument('--log_path', default='result/MSCMNet/log/', type=str, help='log save path')
parser.add_argument('--vis_log_path', default='result/MSCMNet/log/vis_log/', type=str, help='log save path')
